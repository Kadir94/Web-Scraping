...
async def get_info(origin, destination,date,logger):
    ...
    for d, a in zip(departure_times,arrival_times):
         dict.append({
            'Origin': origin,
...
asyncio.get_event_loop().run_until_complete(get_info('Tel Aviv-University', 'Tel Aviv-Savidor Center',datetime.datetime.today(),logger=None))
