...
async def get_info(origin, destination,date):
    ...
    await page.waitForXPath('//*[@id="ZA_CAMP_DIV_1"]',{'visible': True, 'timeout': 50000})
    await page.evaluate('''(selector) => document.querySelector(selector).click()''',"#ZA_CANVAS_763351_CLOSE_X2_13_IMG")
    await asyncio.sleep(1)
    await page.waitForXPath('//*[@id="trainSearchMain"]/div/div/div/div[2]/div[2]/input',{'visible': True, 'timeout': 50000})
    ...
    await page.waitForXPath('//*[@id="trainSearchMain"]/div/div/div/div[4]/div[2]/input',{'visible': True, 'timeout': 50000})
